...
function trafficContext() {
  ...
  return Object.fromEntries(
    Object.entries(mappings)
      .map(([queryKey, eventKey]) => [eventKey, search.get(queryKey)])
      .filter(([, value]) => value),
  );
}
...
function track(name, params) {
  if (typeof window !== "undefined" && typeof window.gtag === "function") {
    window.gtag("event", name, { ...trafficContext(), ...(params || {}) });
  }
}
...
const AFFILIATES = [
  ...
  },
  {
    ...
    name: "ホワイトマイスター",
    area: "東京・銀座(銀座駅N1出口 徒歩1分)",
    areaGroup: "ginza",
    tag: "オフィス/ホーム",
    methods: ["office", "home"],
    price: "デュアル 初回 ¥31,000(税込)",
    note: "ホワイトニング専門歯科 / 完全個室・マッサージチェア / 通院1回で完結するデュアル",
    reason: "銀座で、通院1回でしっかり白さを目指したい方に",
    cta: "銀座の初回メニューを確認する →",
  ...
  },
  {
    ...
    methods: ["office"],
    price: "1回 ¥2,970(税込)〜",
    note: "医療機関の薬剤を使用 / 平日20時まで・土日祝も診療",
    reason: "大阪で、通いやすさと価格の両方を重視したい方に",
    cta: "大阪の料金と予約枠を見る →",
    stickyCta: "大阪の料金と予約枠を見る",
    priority: 4,
    verifiedAt: "2026年7月",
    href: "https://t.afi-b.com/visit.php?a=d13632t-T466954h&p=i987887d",
    pixel: "https://t.afi-b.com/lead/d13632t/i987887d/T466954h",
  ...
  },
  {
    ...
    methods: ["self"],
    price: "初回限定キャンペーンあり",
    note: "医薬部外品のホワイトニングジェル / 90日間返金保証(定期コース限定)",
    reason: "通わずに、毎日の歯みがきから始めたい方に",
    cta: "初回限定キャンペーンを見る →",
    stickyCta: "初回限定キャンペーンを見る",
    priority: 5,
    verifiedAt: "2026年7月",
    href: "https://t.afi-b.com/visit.php?a=g12737B-I424874L&p=i987887d",
    pixel: "https://t.afi-b.com/lead/g12737B/i987887d/I424874L",
    page: "/clinic/lulu-white.html",
  },
];
...
export default function WhiteningSimulator() {
  ...
  const trackAffiliateClick = (offer, position, extra = {}) => track("affiliate_click", {
    ...offerParams(offer, position),
    clinic: offer.name,
    ...extra,
  });
  const trackOutboundOffer = (offer, position, extra = {}) => {
    trackOfferClick(offer, position);
    trackAffiliateClick(offer, position, extra);
  };
                        ...
                        >
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 14, gap: 10, flexWrap: "wrap" }}>
                            ...
                            <a
                              ...
                              onClick={(e) => { e.stopPropagation(); trackOutboundOffer(c, "clinic_list", { method: g.key }); }}
                ...
                <div ref={offerCardRef} style={{ marginTop: 18 }}>
                  ...
                  <div style={{ background: C.card, borderRadius: 18, padding: 18, border: `2px solid ${C.gold}`, boxShadow: "0 6px 18px rgba(192,145,60,0.15)" }}>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="nofollow sponsored noopener"
                      onClick={() => trackOutboundOffer(recommendedOffer, "result_primary")}
      ...
      {screen === "sim" && editMode === "compare" && imgSrc && !offerCardVisible && (
        <div style={{ position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 50, background: "rgba(255,255,255,0.96)", backdropFilter: "blur(6px)", borderTop: `1px solid ${C.line}`, boxShadow: "0 -4px 16px rgba(0,0,0,0.08)", padding: "10px 16px calc(10px + env(safe-area-inset-bottom))" }}>
          <a
            ...
            target="_blank"
            rel="nofollow sponsored noopener"
            onClick={() => trackOutboundOffer(recommendedOffer, "result_sticky")}
